...
public class TemplateInstancesResource extends AbstractOpenViewResource {
  ...
  @ApiResponses({
      ...
      @ApiResponse(responseCode = "404", content = @Content(schema = @Schema(implementation = CedarError.class)), description = "No such template instance"),
  ...
  public Response findTemplateInstance(
    ...
    return resolveArtifact(id, CedarResourceType.INSTANCE);
  }
