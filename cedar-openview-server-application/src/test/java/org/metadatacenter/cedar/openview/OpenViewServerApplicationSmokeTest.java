 ...
 * cannot see.
 */
public class OpenViewServerApplicationSmokeTest {

  @ClassRule
  public static final DropwizardAppRule<OpenViewServerConfiguration> SERVER =
      new DropwizardAppRule<>(OpenViewServerApplication.class, ResourceHelpers.resourceFilePath("test-config.yml"));
