package org.metadatacenter.cedar.fairdata.config;
...
public class CedarConfigFairdataTest {
  ...
  public void setEnvironment() {
    ...
    env.put(CedarEnvironmentVariable.CEDAR_FAIRDATA_HTTP_PORT.getName(), "9013");
    env.put(CedarEnvironmentVariable.CEDAR_FAIRDATA_ADMIN_PORT.getName(), "9113");
    env.put(CedarEnvironmentVariable.CEDAR_FAIRDATA_STOP_PORT.getName(), "9213");
